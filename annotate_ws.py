...
os.environ['CORENLP_HOME'] = "/Users/stevewu/Documents/NLP-SQL/sqlova/stanford-corenlp-4.5.2"
...
def annotate(sentence, lower=True):
    global client
    if client is None:
        # client = CoreNLPClient(default_annotators='ssplit,tokenize'.split(','), properties="zh")
